...
function registerUser(name, last_name, avatar, email, password, created_at, res, next) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    if (user)
                        return [2 /*return*/, res.status(409).send("email-in-use")];
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Something went wrong trying to register user:", error_1);
